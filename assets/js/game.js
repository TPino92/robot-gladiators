...
var fightOrSkip = function() {
  ...
  var promptFight = window.prompt('Would you like to FIGHT or SKIP this battle? Enter "FIGHT" or "SKIP" to shoose.');
  ...
  //if user picks 'skip' confirm stop loop 
  if (promptFight === "skip") {
...
var shop = function () {
  ...
  var shopOptionPrompt = window.prompt(
    "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the shop, Please enter one: '1' to refill Health, '2' to upgrade your Attack, or '3' to Leave. Make your choice."
  );
